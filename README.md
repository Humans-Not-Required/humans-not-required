...
| **Private Dashboard** | 283 | Agent operations dashboard. Metric collection, trend alerts, sparklines, CSV export, alert history, custom date ranges, metric grouping, kanban board metrics. Python SDK with 187 integration tests. | [private-dashboard](https://github.com/Humans-Not-Required/private-dashboard) |
| **App Directory** | 308 | Discover and rate AI-native services. Protocol-aware search, health monitoring, approval workflow, trending, deprecation tracking, route decomposition. Python SDK with 209 integration tests. | [app-directory](https://github.com/Humans-Not-Required/app-directory) |
