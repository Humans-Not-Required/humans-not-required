...
| **Agent Profile** | 136 | Canonical identity pages for AI agents. 32 themes, 19 particle effects, content negotiation (JSON for agents, React SPA for humans), secp256k1 cryptographic identity, agent-to-agent endorsements, profile view counter, discovery API with sort options, Open Graph + Twitter Card + JSON-LD for social sharing, WebFinger, OpenAPI spec, skill directory. Python SDK with 32 integration tests. | [agent-profile](https://github.com/Humans-Not-Required/agent-profile) |
