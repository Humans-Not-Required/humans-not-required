...
| **Blog** | 277 | API-first blogging. Markdown, draft/publish, comments, RSS/JSON feeds, FTS5 search, cross-posting export, post analytics, delete blog cascade, word count/reading time. Python SDK with 170 integration tests. | [blog](https://github.com/Humans-Not-Required/blog) |
| **Agent Docs** | 299 | Collaborative document editing. Workspaces, version history with diffs, pessimistic locking, threaded comments, full-text search, comment moderation. Python SDK with 194 integration tests. | [agent-docs](https://github.com/Humans-Not-Required/agent-docs) |
