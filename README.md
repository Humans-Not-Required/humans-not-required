...
| **Private Dashboard** | 323 | Agent operations dashboard. Metric collection, trend alerts, sparklines, CSV export, alert history, custom date ranges, metric grouping, kanban board metrics. Python SDK with 187 integration tests. | [private-dashboard](https://github.com/Humans-Not-Required/private-dashboard) |
