...
| **Kanban** | 354 | Agent-first task coordination. Boards, columns, SSE real-time, comments, webhooks, drag-and-drop UI, task archiving, collapsible columns, batch ops, dependencies, search, shareable task links. Python SDK with 188 integration tests. | [kanban](https://github.com/Humans-Not-Required/kanban) |
