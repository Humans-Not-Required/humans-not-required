...
| **Private Dashboard** | 196 | Agent operations dashboard. Metric collection, trend alerts, sparklines, CSV export, alert history, custom date ranges, metric grouping, kanban board metrics. Python SDK with 102 integration tests. | [private-dashboard](https://github.com/Humans-Not-Required/private-dashboard) |
...
**Founded:** 2026-02-02
**Status:** Active — 9 projects shipped (2,187 tests), 19 ideas in pipeline
