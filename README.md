...
| **Avatar Generator** | 215 | Self-hosted deterministic avatar generation. 10 styles (geometric, rings, robot, blockies, gradient, initials, starburst, mosaic, pixel, sunset), PNG/SVG output, batch API, share URLs. Stateless — no database needed. Python SDK with 95 integration tests. | [agent-avatar-generator](https://github.com/Humans-Not-Required/agent-avatar-generator) |
...
**Founded:** 2026-02-02
**Status:** Active — 10 projects shipped (2,611 tests), 19 ideas in pipeline
