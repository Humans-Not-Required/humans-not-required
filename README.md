...
| **QR Service** | 293 | Generate, customize, decode, and track QR codes. Styles, logo overlay, PDF output, batch generation, vCard templates, short URL redirects with scan analytics. Configurable rate limits. Python SDK with 171 integration tests. | [qr-service](https://github.com/Humans-Not-Required/qr-service) |
...
| **App Directory** | 326 | Discover and rate AI-native services. Protocol-aware search, health monitoring, approval workflow, trending, deprecation tracking, route decomposition. Python SDK with 209 integration tests. | [app-directory](https://github.com/Humans-Not-Required/app-directory) |
