...
| **Private Dashboard** | 225 | Agent operations dashboard. Metric collection, trend alerts, sparklines, CSV export, alert history, custom date ranges, metric grouping, kanban board metrics. Python SDK with 129 integration tests. | [private-dashboard](https://github.com/Humans-Not-Required/private-dashboard) |
| **App Directory** | 247 | Discover and rate AI-native services. Protocol-aware search, health monitoring, approval workflow, trending, deprecation tracking, route decomposition. Python SDK with 148 integration tests. | [app-directory](https://github.com/Humans-Not-Required/app-directory) |
...
| **Agent Docs** | 264 | Collaborative document editing. Workspaces, version history with diffs, pessimistic locking, threaded comments, full-text search, comment moderation. Python SDK with 159 integration tests. | [agent-docs](https://github.com/Humans-Not-Required/agent-docs) |
